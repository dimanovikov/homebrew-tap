class Datadiff < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/dimanovikov/datadiff/releases/download/v0.2.0/datadiff-v0.2.0-aarch64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_intel do
      url "https://github.com/dimanovikov/datadiff/releases/download/v0.2.0/datadiff-v0.2.0-x86_64-unknown-linux-gnu.tar.gz"
      sha256 "c628922a5d9644aaf5fc440c87f275c385c82e5569a595bb2a65738e8810a5b8"
    end
    on_arm do
      url "https://github.com/dimanovikov/datadiff/releases/download/v0.2.0/datadiff-v0.2.0-aarch64-unknown-linux-gnu.tar.gz"
